...
Custom cursors for drawing and erasing.
Button enable/disable logic: 
-disallow users from clicking play until an animation exists.
-guider users to tell if they are in draw or erase mode as the respective buttons would be disabled during either mode. 
