...
public class ImageUtil {
	...
	public void saveAnimatedGIF(OutputStream out, List<GifFrame> frames,
		...
		for (GifFrame frame : frames) {
			...
			ImageUtil.configureGIFFrame(metadata,
	...
	private static void configureGIFFrame(IIOMetadata meta, String delayTime,
			int imageIndex, String disposalMethod, int loopCount) {
		...
		if (imageIndex == 0) {
			...
			byte[] uo = new byte[] { 0x1, (byte) (loopCount & 0xFF),
